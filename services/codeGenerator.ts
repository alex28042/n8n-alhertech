...
# -------------------------------------------------------------------------
# Generated by alher tech AI workflows
...
`;
      ...
      case NodeType.CONDITION:
        ...
        print(f"   👉 Condition {variable_name} (${operator} {value}) = {condition_result}")
...
`;
      ...
      case NodeType.DEBUG:
        ...
        print(f"🐞 Debug [${label}]: {json.dumps(input_data, indent=2)}")
        output = input_data
`;
        break;
    ...
    code += `        results['${safeId}'] = output
        print(f"✅ Node '${label}' completed.")
    except Exception as e:
        print(f"❌ Node '${label}' failed: {e}")
        results['${safeId}'] = {"error": str(e)}

`;
  });

  code += `    print("🏁 Workflow Finished.")
    return results
